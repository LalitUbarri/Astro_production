...
import { getCommonHeaders1, getCommonHeaders } from '../configuration/commonFunctions'
import axios from 'axios';
import slw from 'sweetalert';
import PhoneInput from 'react-phone-input-2'
import 'react-phone-input-2/lib/style.css'
import format from 'date-fns/format';
import Banner from '../images/newImages/_bsnl.png';
...
export default function Getkundali() {
    ...
    const handleDateChange = (dob) => {
        // var date = format(new Date(dob), 'yyyy-MM-dd')
        ...
        <>
            ...
            <div className="getlink_container-fluid">
                <div className="getlink_container mt-5">
                    <div className="banner_conatiner mb-4">
                        <img src={Banner} alt="Banner" width="100%" />
                    </div>
                    <div className="heading text-left mb-4">
                        <h4>You will receive horoscope within 48 hours.</h4>
                    </div>
